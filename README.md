...
Identified promising leads based on the Behavioral segmentation using logistic regression so that the sales team may contact leads with a high probability of success. indepth analysis and Visualisation of the dataset using pandas.
Objective
